...
import com.rd.backend.model.dto.user.UserAddRequest;
...
import com.rd.backend.model.dto.user.UserUpdateMyRequest;
import com.rd.backend.model.dto.user.UserUpdateRequest;
...
//    }
    @GetMapping("/get/login")   // 可改成 /me
    public BaseResponse<LoginUserVO> getLoginUser() {
        // 不再需要 HttpServletRequest
        User user = userService.getLoginUser();     // ★ 无参版
        return ResultUtils.success(userService.getLoginUserVO(user));
    }
